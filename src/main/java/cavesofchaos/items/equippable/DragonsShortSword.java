 ...
 * @author domniki
 */
public class DragonsShortSword extends Weapon {
    
    @Override
    public String getName() {
        return "Dragon's ShortSword";
    }
    ...
    public List<ItemEffect> getEffects() {
        ItemEffect effectA = new ItemEffect(ItemEffectType.HP_BONUS, 18);
        ItemEffect effectB = new ItemEffect(ItemEffectType.STR_BONUS, 32);
