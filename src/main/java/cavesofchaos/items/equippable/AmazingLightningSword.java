 ...
 * @author domniki
 */
public class AmazingLightningSword extends Weapon {
    
    @Override
    public String getName() {
        return "Amazing Lightning Sword";
    }
    ...
    public List<ItemEffect> getEffects() {
        ItemEffect effectA = new ItemEffect(ItemEffectType.HP_BONUS, 6);
        ItemEffect effectB = new ItemEffect(ItemEffectType.STR_BONUS, 4);
