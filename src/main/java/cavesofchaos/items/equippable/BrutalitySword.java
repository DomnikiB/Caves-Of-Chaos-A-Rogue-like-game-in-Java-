 ...
 * @author domniki
 */
public class BrutalitySword extends Weapon {
    
    @Override
    public String getName() {
        return "Brutality Sword";
    }
    ...
    public List<ItemEffect> getEffects() {
        ItemEffect effectA = new ItemEffect(ItemEffectType.HP_BONUS, 7);
        ItemEffect effectB = new ItemEffect(ItemEffectType.STR_BONUS, 38);
