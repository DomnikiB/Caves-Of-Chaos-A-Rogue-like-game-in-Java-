 ...
 * @author domniki
 */
public class DeadlyPointyStaff extends Weapon {
    
    @Override
    public String getName() {
        return "Deadly Pointy Staff";
    }
    ...
    public List<ItemEffect> getEffects() {
        ItemEffect effectA = new ItemEffect(ItemEffectType.INT_BONUS, 5);
        ItemEffect effectB = new ItemEffect(ItemEffectType.MP_BONUS, 5);
