 ...
 * @author domniki
 */
public class ThunderstormWarStaff extends Weapon {
    
    @Override
    public String getName() {
        return "Thunderstorm War Staff";
    }
    ...
    public List<ItemEffect> getEffects() {
        ItemEffect effectA = new ItemEffect(ItemEffectType.INT_BONUS, 16);
        ItemEffect effectB = new ItemEffect(ItemEffectType.MP_BONUS, 34);
